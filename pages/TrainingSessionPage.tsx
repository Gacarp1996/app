...
>>>>>>> Stashed changes
  ...
  // 🆕 Log para debugging de recomendaciones
  useEffect(() => {
    console.log('🔄 TrainingSessionPage - Ejercicios actualizados:', {
      count: exercises.length,
      exercises: exercises.map(ex => ({ tipo: ex.tipo, area: ex.area, tiempo: ex.tiempoCantidad }))
    });
  }, [exercises]);
              ...
              <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    {/* 🆕 Indicador de ejercicios actuales */}
...
=======
            ...
            {/* 🆕 Panel de recomendaciones de entrenamiento CON EJERCICIOS ACTUALES */}
            <ActiveSessionRecommendations
              participants={participants.filter(p => activePlayerIds.has(p.id))} // Solo jugadores activos
              academiaId={academiaId}
              sessions={sessions}
              currentExercises={exercises} // 🆕 Pasar ejercicios actuales
            />
>>>>>>> Stashed changes

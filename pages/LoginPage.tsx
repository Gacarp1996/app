  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md p-1 bg-gradient-to-br from-green-500/20 to-cyan-500/20 rounded-2xl shadow-2xl">
        <div className="bg-gray-900/95 backdrop-blur-xl rounded-2xl p-8 space-y-8">
          {/* Header */}
          ...
          <div className="flex bg-gray-800/50 rounded-lg p-1">
            <button className="flex-1 py-2.5 px-4 bg-gradient-to-r from-green-500 to-cyan-500 text-black font-semibold rounded-md transition-all duration-200">
              Iniciar sesión
            </button>
            <button className="flex-1 py-2.5 px-4 text-gray-400 font-medium hover:text-gray-300 transition-colors duration-200">
              Registrarse
            </button>
          </div>
          ...
          <div className="pt-6 border-t border-gray-800">
            <h3 className="text-center text-gray-400 text-sm font-medium mb-4">Funcionalidades Principales</h3>

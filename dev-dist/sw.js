...
define(['./workbox-a6e4201e'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\.(js|css|png|jpg|jpeg|svg|gif|webp)$/, new workbox.StaleWhileRevalidate({
